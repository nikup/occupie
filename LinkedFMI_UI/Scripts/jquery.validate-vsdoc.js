...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Поправи полето.",
		email: "Въведи валиден email адрес.",
		url: "Въведи валиден линк.",
		date: "Въведи валидна дата.",
		dateISO: "Въведи валидна дата (ISO).",
		number: "Въведи валиден номер.",
		digits: "Въведи само числа.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Въведете същата стойност отново.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("Въведи не повече от {0} символа."),
		minlength: $.validator.format("Въведи най-малко {0} символа."),
		rangelength: $.validator.format("Въведи между {0} и {1} символа."),
		range: $.validator.format("Въведи стойност между {0} и {1}."),
		max: $.validator.format("Въведи стойност по-малка или равна на {0}."),
		min: $.validator.format("Въведи стойност по-голяма или равна на {0}.")
	},
